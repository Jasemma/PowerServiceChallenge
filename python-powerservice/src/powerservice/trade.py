...
if __name__ == '__main__':
    """ Present day trades"""
    #todays_datetime = datetime.datetime.strptime(input, '%d/%m/%y')
    #todays_date = datetime.datetime.strftime(todays_datetime, '%d/%m/%Y')
    todaytrades = get_trades(date='13/04/2022')
    ...
    """Previous day trades"""
    #yesterday_datetime = datetime.datetime.strptime(input, '%d/%m/%y')
    #yesterday_date = datetime.datetime.strftime(yesterday_datetime, '%d/%m/%Y')
    yesterdaytrades = get_trades(date='12/04/2022')
